...
var routes = [
    ...
    {
        path: 'view-product',
        loadChildren: function () { return __webpack_require__.e(/*! import() | view-product-view-product-module */ "view-product-view-product-module").then(__webpack_require__.bind(null, /*! ./view-product/view-product.module */ "./src/app/menu-tab/view-product/view-product.module.ts")).then(function (m) { return m.ViewProductPageModule; }); }
    },
];
var MenuTabPageRoutingModule = /** @class */ (function () {
    function MenuTabPageRoutingModule() {
    }
    ...
    return MenuTabPageRoutingModule;
}());
...
var MenuTabPageModule = /** @class */ (function () {
    function MenuTabPageModule() {
    }
...
var MenuTabPage = /** @class */ (function () {
    function MenuTabPage(router) {
        this.router = router;
    ...
    MenuTabPage.prototype.ngOnInit = function () {
        this.viewProducts = this.pizzaProducts;
    };
    MenuTabPage.prototype.onCategoryTabChange = function (event) {
    ...
    MenuTabPage.prototype.onProductClick = function () {
        this.router.navigate(['/menu-tab/view-product']);
    };
    MenuTabPage.ctorParameters = function () { return [
...
//# sourceMappingURL=menu-tab-menu-tab-module-es5.js.map